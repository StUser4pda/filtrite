...
filtrite() {
    ...
    ./deps/ruleset_converter --chrome_version=54 --input_format=filter-list --output_format=unindexed-ruleset --input_files="logs/$1_b0.txt" --output_file="logs/$1_b0.dat" 
    ./deps/ruleset_converter --chrome_version=54 --input_format=unindexed-ruleset --output_format=filter-list --input_files="logs/$1_b0.dat" --output_file="logs/$1_b0.txt" 
    ...
    ./deps/ruleset_converter --chrome_version=54 --input_format=filter-list --output_format=unindexed-ruleset --input_files="logs/$1_b3.txt","logs/$1_b4.txt","rules/myfilters.txt" --output_file="dist/$1.dat" > "logs/$1_3.log" 2>&1
    
    # Generating a filter list (*.txt) too
    ./deps/ruleset_converter --chrome_version=54 --input_format=unindexed-ruleset --output_format=filter-list --input_files="dist/$1.dat" --output_file="dist/$1.txt" > "logs/$1_err4.log" 2>&1
