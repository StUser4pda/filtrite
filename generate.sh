...
filtrite() {
    ...
    deps/ruleset_converter --input_format=filter-list --output_format=unindexed-ruleset --input_files=rules/$1_b3.txt,rules/$1_b4.txt --output_file=dist/$1 2> $1_err3.log
    deps/ruleset_converter --input_format=unindexed-ruleset --output_format=filter-list --input_files=dist/$1.dat --output_file=dist/$1.txt 2> $1_err4.log
    echo "::endgroup::"
}
